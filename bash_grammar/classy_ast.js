...
var $0 = $$.length - 1;
switch (yystate) {
case 1:this.$ = ['PROGRAM',{},$$[$0-6],$$[$0-3],$$[$0-2]]; return this.$;
break;
case 2:this.$ = prependChild($$[$0], $$[$0-1]);
break;
case 3:this.$ = ['CLASS_DECL_LIST',{}];
break;
case 4:this.$ = ['CLASS_DECL',{},$$[$0-6],$$[$0-4],$$[$0-2],$$[$0-1]];
break;
case 5:this.$ = prependChild($$[$0], ['VAR_DECL',{},$$[$0-3],$$[$0-2]]);
break;
case 6:this.$ = ['VAR_DECL_LIST',{}];
break;
case 7:this.$ = prependChild($$[$0], ['METHOD_DECL',{},$$[$0-10],$$[$0-9],$$[$0-7],$$[$0-6],$$[$0-3],$$[$0-2]]);
break;
case 8:this.$ = ['METHOD_DECL_LIST',{}];
break;
case 9:this.$ = ['NAT_TYPE',{}];
break;
case 10:this.$ = $$[$0]
break;
case 11:this.$ = ['AST_ID',{val:yytext}]
break;
case 12:this.$ = prependChild($$[$0], $$[$0-2]);
break;
case 13:this.$ = ['EXPR_LIST',{},$$[$0-1]];
break;
case 14:this.$ = ['NAT_LITERAL_EXPR',{val:parseInt(yytext)}];
break;
case 15:this.$ = ['NULL_EXPR',{}];
break;
case 16:this.$ = ['ID_EXPR',{},$$[$0]];
break;
case 17:this.$ = ['NEW_EXPR',{},$$[$0]];
break;
case 18:this.$ = ['THIS_EXPR',{}];
break;
case 19:this.$ = ['IF_THEN_ELSE_EXPR',{},$$[$0-8],$$[$0-5],$$[$0-1]];
break;
case 20:this.$ = ['FOR_EXPR',{},$$[$0-8],$$[$0-6],$$[$0-4],$$[$0-1]];
break;
case 21:this.$ = ['READ_EXPR',{}];
break;
case 22:this.$ = ['PRINT_EXPR',{},$$[$0-1]];
break;
case 23:this.$ = ['PLUS_EXPR',{},$$[$0-2],$$[$0]];
break;
case 24:this.$ = ['MINUS_EXPR',{},$$[$0-2],$$[$0]];
break;
case 25:this.$ = ['TIMES_EXPR',{},$$[$0-2],$$[$0]];
break;
case 26:this.$ = ['EQUALITY_EXPR',{},$$[$0-2],$$[$0]];
break;
case 27:this.$ = ['GREATER_THAN_EXPR',{},$$[$0-2],$$[$0]];
break;
case 28:this.$ = ['NOT_EXPR',{},$$[$0]];
break;
case 29:this.$ = ['OR_EXPR',{},$$[$0-2],$$[$0]];
break;
case 30:this.$ = ['DOT_ID_EXPR',{},$$[$0-2],$$[$0]];
break;
case 31:this.$ = ['ASSIGN_EXPR',{},$$[$0-2],$$[$0]];
break;
case 32:this.$ = ['DOT_ASSIGN_EXPR',{},$$[$0-4],$$[$0-2],$$[$0]];
break;
case 33:this.$ = ['METHOD_CALL_EXPR',{},$$[$0-3],$$[$0-1]];
break;
case 34:this.$ = ['DOT_METHOD_CALL_EXPR',{},$$[$0-5],$$[$0-3],$$[$0-1]];
break;
case 35:this.$ = $$[$0-1];
break;
}
...
exports.parse = function () { return classy_ast.parse.apply(classy_ast, arguments); };
